...
# DO NOT change working directory - this breaks git worktree workflows
# All paths below are already absolute (using $REPO_ROOT prefix)
# Changing to $REPO_ROOT abandons worktree context and creates files in main repo
